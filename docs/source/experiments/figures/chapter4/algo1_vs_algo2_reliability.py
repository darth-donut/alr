...
def solo_reliability_plot(calib_metrics, title="Reliability plot"):
    ...
    reliability_hist_plot(bins_E_M, counts_E_N, axes[0], xticklabels=False, title=title, bar=True)
    reliability_plot(bins_E_M, bin_accuracy_E_N, counts_E_N, axes[1], title=None)



root = Path("/Users/harry/Documents/workspace/thesis/figures/3/data/cifar_eph_vs_eph2_calib/calib_metrics")
solo_reliability_plot(root / "eph", title="(Algorithm 1) Reliability plot")
savefig("/Users/harry/Documents/workspace/thesis/figures/3/algo1_reliability_cifar10.pdf")

root = Path("/Users/harry/Documents/workspace/thesis/figures/3/data/cifar_eph_vs_eph2_calib/calib_metrics")
solo_reliability_plot(root / "eph2", title="(Algorithm 2) Reliability plot")
savefig("/Users/harry/Documents/workspace/thesis/figures/3/algo2_reliability_cifar10.pdf")
