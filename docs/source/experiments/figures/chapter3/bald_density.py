...
bald = Path("/Users/harry/Documents/workspace/thesis/figures/4/data/ens_bald_metrics/bald_10_96")
...
def ridge_plot(distributions: list,
               title: str,
    ...
    for i, dist in tqdm.tqdm(enumerate(distributions)):
        ...
        ax_objs[-1].fill_between(x_d, np.exp(logprob), color=cmap(i / len(distributions)),
                                 alpha=0.3)
