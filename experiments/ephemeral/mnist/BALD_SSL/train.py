        ...
        for i in range(1, ITERS + 1):
            ...
            with dm.unlabelled.tmp_debug():
                trainer = EphemeralTrainer(
                    ...
                    min_labelled=0.1,
                    log_dir=(calib_metrics / "SSL" / f"rep_{r}" / f"iter_{i}"), patience=(3, 7),
                    reload_best=True,
            ...
            supervised_trainer = Trainer(
                model, F.nll_loss, 'Adam', patience=3,
            ...
            def _save_pl_metrics(e):
                ...
                save_pl_metrics.run(torchdata.DataLoader(dm.unlabelled, batch_size=512, shuffle=False, **kwargs))
            callbacks = [_save_pl_metrics]
            with dm.unlabelled.tmp_debug():
                supervised_trainer.fit(train_loader, val_loader, epochs=EPOCHS, callbacks=callbacks)
