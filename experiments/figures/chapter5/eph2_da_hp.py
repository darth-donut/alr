...
alpha = [1, 0.1, 0.4, 4]
drop = [0.1, 0.5]
root = Path("/Users/harry/Documents/workspace/thesis/experiments/plmixup/cifar10/tryouts/explore/results")
...
# Jitter vs no Jitter
with open("/Users/harry/Documents/workspace/thesis/experiments/plmixup/cifar10/tryouts/with_jitter/results/SGD_alpha_1_drop_0.5_size_1000_jitter/metrics.pkl", "rb") as fp:
    metrics = CPUUnpickler(fp).load()
plt.plot(metrics['val_acc'], label="Standard Aug. + Colour Jittering")
with open("/Users/harry/Documents/workspace/thesis/experiments/plmixup/cifar10/tryouts/without_jitter/results/SGD_alpha_0.1_drop_0.5_size_1000_aug/metrics.pkl", "rb") as fp:
    metrics = CPUUnpickler(fp).load()
plt.plot(metrics['val_acc'], label="Standard Aug.")
with open("/Users/harry/Documents/workspace/thesis/experiments/plmixup/cifar10/tryouts/explore/results/SGD_alpha_0.1_drop_0.5/metrics.pkl", "rb") as fp:
    metrics = CPUUnpickler(fp).load()
