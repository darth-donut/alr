...
dataset = "cifar"
root = Path(f"./data_files/{dataset}_ensemble")
...
if SAVE:
    savefig("/Users/harry/Documents/workspace/thesis/figures/4/ens_bald_sorted.pdf")
...
if SAVE:
    savefig("/Users/harry/Documents/workspace/thesis/figures/4/ens_bald_dist.pdf")
