#  wide resent-28 with dropout
# from https://github.com/EricArazo/PseudoLabeling/blob/master/utils_pseudoLab/wideArchitectures.py
import torch
...
def WRN28_2_wn(num_classes=10, dropout=0.0):
    model = Wide_ResNet_WN(
        wide_WN, depth=28, widen_factor=2, dropout_rate=dropout, num_classes=num_classes
    )
    return model
