r"""
repeat train.py for the no al variant. see where it plateaus to. Can it reach
...
def main(use_al, b, threshold, log_every):
    ...
    accs = []
    template = f"{'al' if use_al else 'no_al'}_b={b}_thresh={threshold}_iters={ITERS}"
    ...
    for r in range(1, REPS + 1):
        ...
        for i in range(1, ITERS + 1):
            ...
            accs_r[train_length] = test_metrics["acc"]
...
if __name__ == "__main__":
    main(use_al=False, b=10, threshold=0.9, log_every=4)
